    ...
    async def create_payment_checkout(self, donation: DonationRequest, merchant_id: str, access_token: str, test_mode: bool = True):
        ...
        try:
            ...
            checkout_config = {
                ...
                "test_mode": test_mode,
                "return_url": "https://giftflow.preview.emergentagent.com/success",
                "cancel_url": "https://giftflow.preview.emergentagent.com/cancel"
            }
    ...
    async def create_payment_checkout(self, donation: DonationRequest, merchant_id: str, access_token: str, test_mode: bool = True) -> Dict:
        ...
        try:
            ...
            checkout_config = {
                ...
                "return_url": f"https://giftflow.preview.emergentagent.com/success",
                "cancel_url": f"https://giftflow.preview.emergentagent.com/cancel"
            }
...
async def serve_test_donation_embed(org_id: Optional[str] = None):
    ...
    <body>
        ...
        <script>
            const API_BASE = 'https://giftflow.preview.emergentagent.com/api';
...
async def serve_donation_embed(org_id: str):
    ...
    try:
        ...
        <body>
            ...
            <script>
                const ORG_ID = '{org_id}';
                const API_BASE = 'https://gitflow.preview.emergentagent.com/api';
                const BB_PUBLIC_KEY = '{public_key}';
