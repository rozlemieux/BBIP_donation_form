...
# Blackbaud API URLs
BB_BASE_URL = "https://api.sky.blackbaud.com"
...
def test_checkout_creation():
    ...
    headers = {
        ...
        "Environment": "sandbox"  # Add environment header
    }
...
def main():
    ...
    checkout = test_checkout_creation()
    logging.info(f"Checkout creation test: {'PASSED' if checkout else 'FAILED'}")
